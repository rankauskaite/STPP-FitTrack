    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerClients", x => new { x.ClientsId, x.UserId });
                    table.ForeignKey(
                        name: "FK_TrainerClients_Users_ClientsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedByUsersId = table.Column<int>(type: "integer", nullable: false),
                    SavedPlansId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedPlans", x => new { x.SavedByUsersId, x.SavedPlansId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSavedPlans_Users_SavedByUsersId",
